      ...
      <BackgroundRippleLayout tone="light" showRipple={false} contentClassName="pt-[74px]">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-ink-900 mx-auto mb-4"></div>
            <p className="text-ink-500">Loading blog posts...</p>
          </div>
        </div>
    ...
    <BackgroundRippleLayout tone="light" showRipple={false} contentClassName="pt-[74px]">
      ...
      <div className="pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-xs uppercase tracking-[0.35em] text-ink-500 mb-4">Off-Campus Job Hunt</p>
            <h1 className="text-5xl md:text-6xl font-medium tracking-[-0.02em] mb-4 text-ink-900">Complete Playbook</h1>
            <p className="text-ink-600 text-lg max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <div className="bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <h2 className="text-xl font-semibold text-ink-900 mb-6 text-center">Table of Contents</h2>
              <div className="grid md:grid-cols-2 gap-4 text-ink-700">
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 1</span>
                  <span>Off-Campus Strategy Roadmap (7 Steps)</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 2</span>
                  <span>Timing Guide — When to Connect &amp; Send</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 3</span>
                  <span>Cold Calling Script (Full + Short Version)</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 4</span>
                  <span>Cold Email Templates (3 Versions)</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 5</span>
                  <span>LinkedIn Connection Message Templates</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-ink-400 font-semibold">SECTION 6</span>
                  <span>Follow-Up System (Day-by-Day Schedule)</span>
                </div>
                <div className="flex items-start gap-3 md:col-span-2">
                  <span className="text-ink-400 font-semibold">SECTION 7</span>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -right-20 -top-24 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    Strategy Roadmap
                  </span>
                </div>
                <h2 className="text-2xl md:text-3xl font-medium text-ink-900 mb-2">
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 1 — Build Your Profile Before You Reach Out</h3>
                  <p className="text-ink-600 mb-2">
                    <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">
                      Why this matters
                    </span>
                  </p>
                  <p className="text-ink-700 mb-3">HRs check your LinkedIn before responding. A weak profile = no reply.</p>
                  <p className="text-ink-600 mb-2">
                    <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">
                      Action items
                    </span>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 2 — Pick Your Target Companies (10 at a Time)</h3>
                  ...
                  <p className="text-ink-700 mb-3">Pick 10 companies per week. Research each one before reaching out.</p>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 3 — LinkedIn First, Then Call, Then Email</h3>
                  <p className="text-ink-700 mb-3">This is the exact sequence that works best:</p>
                  <div className="grid md:grid-cols-2 gap-2 text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 4 — Prepare Your Pitch (30-Second Version)</h3>
                  <p className="text-ink-700 mb-3">Before you call or message, prepare this exact pitch:</p>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 5 — Send Resume the Right Way</h3>
                  <p className="text-ink-700 mb-2">Resume file name format:</p>
                  <p className="text-ink-700 mb-2">
                    FirstName_LastName_Role_Resume.pdf (Example: Rahul_Sharma_DataAnalyst_Resume.pdf)
                  </p>
                  <p className="text-ink-700 mb-2">Email subject line format:</p>
                  <p className="text-ink-700 mb-3">Application for [Role] | [Your Name] | [College Name]</p>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-2">STEP 6 — Track Every Outreach</h3>
                  <p className="text-ink-700 mb-3">Create a simple tracker in Excel or Notion with these columns:</p>
                  <div className="grid md:grid-cols-2 gap-2 text-ink-700">
          ...
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -left-24 -top-16 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    Timing Guide
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">BEST DAYS TO REACH OUT</h3>
                  <div className="space-y-2">
                    <p>
                      <span className="font-semibold">Tuesday</span>{" "}
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">BEST DAY</span>{" "}
                      — HRs are settled into the week. Highest open rates.
                    </p>
                    <p>
                      <span className="font-semibold">Wednesday</span>{" "}
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">SECOND BEST</span>{" "}
                    ...
                    <p>
                      ...
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">Avoid</span>{" "}
                    ...
                    <p>
                      ...
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">Never</span>{" "}
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">BEST TIME WINDOWS</h3>
                  <div className="space-y-2">
                    <p>
                      <span className="font-semibold">9:00 AM – 10:30 AM</span>{" "}
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">PRIME WINDOW</span>{" "}
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">MARCH SPECIFIC TIMING</h3>
                  <p className="text-ink-700 mb-2">Why March is special:</p>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
                  ...
                  <p className="text-ink-700 mt-4 mb-2">Best weeks in March to be most active:</p>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
          ...
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -right-24 -bottom-24 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    Cold Calling
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">FULL SCRIPT — Step by Step</h3>
                  <div className="space-y-4">
                    <div className="rounded-(--jf-radius-frame) border border-border-soft bg-surface-alt/60 p-4">
                      <p className="text-sm font-semibold text-sapphire-brand mb-3">OPENING (First 10 seconds)</p>
                      <div className="space-y-2 text-ink-700">
                        <p><span className="font-semibold text-sapphire-brand">You:</span> Good morning / Good afternoon! May I speak with [HR Name]?</p>
                        <p className="text-ink-500 italic">[ Wait for confirmation ]</p>
                        <p><span className="font-semibold text-sapphire-brand">You:</span> Hi [HR Name], my name is [Your Name]. I am a [Your Degree] graduate from [Your College / University]. I hope I am not catching you at a bad time.</p>
                      </div>
                    </div>

                    <div className="rounded-(--jf-radius-frame) border border-border-soft bg-page p-4">
                      <p className="text-sm font-semibold text-sapphire-brand mb-3">YOUR PITCH (15–20 seconds)</p>
                      <div className="space-y-2 text-ink-700">
                        <p><span className="font-semibold text-sapphire-brand">You:</span> I came across your profile on LinkedIn and I can see that you handle recruitment at [Company Name].
                    ...
                    <div className="rounded-(--jf-radius-frame) border border-border-soft bg-surface-alt/60 p-4">
                      <p className="text-sm font-semibold text-sapphire-brand mb-3">CLOSING</p>
                      <div className="space-y-2 text-ink-700">
                        <p><span className="font-semibold text-sapphire-brand">You:</span> Thank you so much for your time, [HR Name]. I really appreciate it. I will make sure my resume is in your inbox. Have a great day!</p>
                        <p className="text-ink-500 italic">[ Hang up politely. Never drag the call. ]</p>
                      </div>
                    </div>

                    <div className="rounded-(--jf-radius-frame) border border-border-soft bg-page p-4">
                      <p className="text-sm font-semibold text-sapphire-brand mb-3">HANDLING COMMON RESPONSES</p>
                      <div className="space-y-3 text-ink-700">
                        <div>
                          <p className="font-semibold text-ink-900">IF THEY SAY "WE ARE NOT HIRING":</p>
                        ...
                        <div>
                          <p className="font-semibold text-ink-900">IF THEY SAY "SEND YOUR RESUME":</p>
                          <p>Of course! I have already sent it to [their email if you know it]. Could I confirm the best email address to send it to?</p>
                        </div>
                        <div>
                          <p className="font-semibold text-ink-900">IF THEY SAY "CALL BACK LATER":</p>
                          <p>Absolutely, when would be the best time to call back? <span className="text-ink-500 italic">[ Note down the time they give and call EXACTLY then. ]</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">SHORT SCRIPT — Under 60 Seconds</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">CALLING TIPS</h3>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
          ...
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -left-24 -bottom-24 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    Email Templates
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  ...
                  <div className="border border-border-soft rounded-(--jf-radius-frame) overflow-hidden bg-page">
                    <div className="bg-surface-alt border-b border-border-soft px-4 py-3 text-xs text-ink-600 space-y-1">
                      <p><span className="font-semibold text-ink-700">Subject:</span> Application for [Role] | [Your Name] | [Your College]</p>
                      <p><span className="font-semibold text-ink-700">To:</span> [HR First Name]</p>
                      <p><span className="font-semibold text-ink-700">From:</span> [Your Name]</p>
                    </div>
                    <div className="px-4 py-4 text-[13px] leading-relaxed text-ink-700 font-mono bg-page space-y-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">TEMPLATE 2 — Startup / Growth Company Email</h3>
                  <div className="border border-border-soft rounded-(--jf-radius-frame) overflow-hidden bg-page">
                    <div className="bg-surface-alt border-b border-border-soft px-4 py-3 text-xs text-ink-600 space-y-1">
                      <p><span className="font-semibold text-ink-700">Subject:</span> Excited About [Company Name] — [Your Name] Reaching Out</p>
                      <p><span className="font-semibold text-ink-700">To:</span> [HR First Name]</p>
                      <p><span className="font-semibold text-ink-700">From:</span> [Your Name]</p>
                    </div>
                    <div className="px-4 py-4 text-[13px] leading-relaxed text-ink-700 font-mono bg-page space-y-3">
                ...
                <div>
                  ...
                  <div className="border border-border-soft rounded-(--jf-radius-frame) overflow-hidden bg-page">
                    <div className="bg-surface-alt border-b border-border-soft px-4 py-3 text-xs text-ink-600 space-y-1">
                      <p><span className="font-semibold text-ink-700">Subject:</span> Following Up — [Your Name] | [Role/Domain]</p>
                      <p><span className="font-semibold text-ink-700">To:</span> [HR First Name]</p>
                      <p><span className="font-semibold text-ink-700">From:</span> [Your Name]</p>
                    </div>
                    <div className="px-4 py-4 text-[13px] leading-relaxed text-ink-700 font-mono bg-page space-y-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">EMAIL TIPS</h3>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
          ...
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -right-20 -top-20 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    LinkedIn Messages
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">MESSAGE 1 — General Connection Request</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">MESSAGE 2 — After They Accept Your Connection</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">MESSAGE 3 — Referencing a Job Post</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">MESSAGE 4 — Startup / Direct Approach</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">LINKEDIN TIPS</h3>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
                    <li>
                      <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-2 py-0.5 text-xs font-semibold text-sapphire-brand">
                        Do NOT
          ...
          >
            <div className="relative overflow-hidden bg-page border border-border-soft rounded-(--jf-radius-panel) p-6 md:p-8 shadow-[var(--jf-shadow-frame)]">
              <div className="absolute inset-x-0 top-0 h-1 bg-sapphire-bright" />
              <div className="absolute -left-24 -top-24 h-48 w-48 rounded-full bg-sapphire-50/70 blur-3xl" />
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="inline-flex items-center rounded-(--jf-radius-pill) bg-sapphire-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sapphire-brand">
                    Follow-Up System
              ...
              <div className="space-y-8 text-ink-700">
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">14-DAY FOLLOW-UP SCHEDULE</h3>
                  <div className="grid md:grid-cols-2 gap-2 text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">WHAT TO SAY IN THE FINAL FOLLOW-UP</h3>
                  <blockquote className="border-l-4 border-sapphire-bright pl-4 italic text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">AFTER YOU GET A RESPONSE</h3>
                  <div className="space-y-2 text-ink-700">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-ink-900 mb-3">WEEKLY TARGETS TO STAY ON TRACK</h3>
                  <p className="text-ink-700 mb-2">Set these as your weekly goals:</p>
                  <ul className="list-disc pl-5 space-y-1 text-ink-700">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {categories.map((category) => (
                <button
                  ...
                  className={`rounded-(--jf-radius-pill) px-4 py-2 text-sm font-medium transition-colors ${selectedCategory === category.name
                      ? "bg-ink-900 text-white"
                      : "bg-page text-ink-600 border border-border-soft hover:bg-surface-alt"
                    }`}
                >
                  {category.name}
                  {category.count > 0 && (
          ...
          {selectedCategory === "All" && featuredPosts.length > 0 && (
            <motion.div
              ...
              className="mb-16"
            >
              <h2 className="text-2xl font-medium mb-8 text-center text-ink-900">Featured</h2>
              <div className="grid md:grid-cols-2 gap-8">
                {featuredPosts.slice(0, 2).map((post, index) => (
                  ...
                  >
                    <div className="bg-page rounded-(--jf-radius-frame) p-6 h-full border border-border-soft hover:border-border-frame transition-all duration-300 shadow-[var(--jf-shadow-frame)] hover:shadow-[var(--jf-shadow-panel)]">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="bg-ink-900 text-white px-3 py-1 rounded-(--jf-radius-pill) text-xs font-semibold">
                          Featured
                        </span>
                      ...
                      <h3 className="text-xl font-medium mb-3 text-ink-900 group-hover:text-ink-700 transition-colors">
                        {post.title}
                      </h3>
          ...
          >
            {posts.map((post, index) => (
              <motion.article
                ...
                className="group cursor-pointer border-b border-border-soft pb-8 last:border-b-0"
                onClick={() => window.location.href = `/blog/${post.slug}`}
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2 text-sm text-ink-500">
                      <span>{formatDate(post.publishedAt)}</span>
                    ...
                    <h2 className="text-xl md:text-2xl font-medium mb-3 text-ink-900 group-hover:text-ink-700 transition-colors">
                      {post.title}
                    </h2>
          ...
          {totalPages > 1 && (
            ...
            >
              ...
              <span className="text-sm text-ink-500">
                Page <span className="font-semibold text-ink-900">{currentPage}</span> of {totalPages}
              </span>
      ...
      {/* Footer */}
      <footer className="border-t border-border-soft py-12 px-4 bg-page">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-8 text-ink-500 text-sm">
            ...
            <a href="#" className="hover:text-ink-700 transition-colors">Support</a>
          </div>
